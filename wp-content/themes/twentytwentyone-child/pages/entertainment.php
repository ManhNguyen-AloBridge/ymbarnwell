...
$argsRecent = array('category' => get_option('data_config')['ENTERTAINMENT_CATEGORY_ID'], 'post_type' =>  'post', 'numberposts' => get_option('data_config')['RECENT_POST_NUMBER']);
$recentPosts = get_posts($argsRecent);
$pageData = get_page(get_option('data_config')['ENTERTAINMENT_PAGE_ID']);
...
$args = array(
    ...
    'order'          => 'DESC',
    'cat' => get_option('data_config')['ENTERTAINMENT_CATEGORY_ID'],
...
<div class="entertainment-page">
    <div class="container-lg">
        <div class="entertainment__head">
            <h1 class="entertainment__title fs-18 fw-700 lh-25"><?= $pageData->post_title ?></h1>
            <p class="entertainment__description">
                ...
                ?>
                        <div class="entertainment-content-item">
                            <a class="link-image-to-detail" href="<?= get_the_permalink($post->id) ?>">
                                <img class="entertainment-content-item__image" src="<?= get_image_thumbnail_post($post) ?>" alt="">
                            </a>
                            <div class="entertainment-content-item__info">
                                <a class="link-to-detail" href="<?= get_the_permalink($post->id) ?>">
                                    <h3 class="entertainment-content-item__title fs-16 fw-700 lh-22"><?= $post->post_title ?></h3>
                                </a>
